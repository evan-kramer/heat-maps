...
# Master crosswalks
a = read_csv("projects/2017_district_accountability/min_performance_goal_mb.csv")
...
# Participation Rates
part_rates = read_csv("projects/2017_district_accountability/min_performance_goal_mb.csv") %>% 
...
min_goal = read_csv("projects/2017_district_accountability/min_performance_goal_mb.csv") %>% 
    filter(is.na(subgroup)) %>% 
